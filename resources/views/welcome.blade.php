...
<html lang="en">
    <head>
        ...
        <!-- Icon css link -->
        <link href="{{ asset('frontend/vendors/material-icon/css/materialdesignicons.min.css')}}" rel="stylesheet">
        <link href="{{ asset('frontend/css/font-awesome.min.css')}}" rel="stylesheet">
        <link href="{{ asset('frontend/vendors/linears-icon/style.css')}}" rel="stylesheet">
        <!-- Bootstrap -->
        ...
        <link href="{{ asset('frontend/vendors/bootatrap-date-time/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
        <link href="{{ asset('frontend/vendors/owl-carousel/assets/owl.carousel.css')}}" rel="stylesheet">
                ...
                <div class="rev_slider fullwidthabanner"  data-version="5.3.0.2" id="home-slider">
                    <ul> 
                        <li data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="600" data-rotate="0" data-saveperformance="off">
                            <!-- MAIN IMAGE -->
                        <img src="{{ asset('img/home-slider/slider-1.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                        ...
                        <li data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="600" data-rotate="0" data-saveperformance="off">
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('img/home-slider/slider-2.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="service_item">
                            <img src="{{ asset('img/service-icon/service-1.png')}}" alt="">
                            <h3>Pizzas</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="service_item">
                            <img src="{{ asset('img/service-icon/service-2.png')}}" alt="">
                            <h3>Coffee</h3>
                            <p>Lorem ipsum dolor sit amet, cont tempor incididunt ut labore dolor adipiscing elit, sed do eiusmod et  magna aliquaquat officia.</p>
                            <a class="read_mor_btn" href="#">Read More</a>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="service_item">
                            <img src="{{ asset('img/service-icon/service-3.png')}}" alt="">
                            <h3>Burgers</h3>
                            <p>Lorem ipsum dolor sit amet, cont tempor incididunt ut labore dolor adipiscing elit, sed do eiusmod et  magna aliquaquat officia.</p>
                            <a class="read_mor_btn" href="#">Read More</a>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="service_item">
                            <img src="{{ asset('img/service-icon/service-4.png')}}" alt="">
                            <h3>Drinks</h3>
                            <p>Lorem ipsum dolor sit amet, cont tempor incididunt ut labore dolor adipiscing elit, sed do eiusmod et  magna aliquaquat officia.</p>
                            <a class="read_mor_btn" href="#">Read More</a>
                        </div>
                ...
                <div class="p_recype_item_main">
                    <div class="row p_recype_item_active">
                        <div class="col-md-6 break snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-1.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-2.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 lunch snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-3.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 lunch dinner">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-4.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-5.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 break coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-6.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 lunch coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-7.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 dinner snacks">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-8.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 dinner coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-9.jpg')}}" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                        ...
                        <div class="col-md-6 dinner coffee">
                            <div class="media">
                                <div class="media-left">
                                    <img src="{{ asset('img/recype/recype-10.jpg')}}t="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h3>Vegetable Flavour</h3></a>
                                    <h4>$32</h4>
                ...
                <div class="chefs_slider_active">
                    <div class="item">
                        <div class="chef_item_inner">
                            <div class="chef_img">
                                <img src="{{ asset('img/chef/chef-1.jpg')}}t="">
                    ...
                    <div class="item">
                        <div class="chef_item_inner">
                            <div class="chef_img">
                                <img src="{{ asset('img/chef/chef-2.jpg')}}t="">
                                <div class="chef_hover">
                                    <a href="#"><h4>Thomas Keller</h4></a>
                                    <h5>Chef</h5>
                                    <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                    ...
                    <div class="item">
                        <div class="chef_item_inner">
                            <div class="chef_img">
                                <img src="{{ asset('img/chef/chef-3.jpg')}}t="">
                                <div class="chef_hover">
                                    <a href="#"><h4>Thomas Keller</h4></a>
                                    <h5>Chef</h5>
                                    <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                    ...
                    <div class="item">
                        <div class="chef_item_inner">
                            <div class="chef_img">
                                <img src="{{ asset('img/chef/chef-4.jpg')}}t="">
                                <div class="chef_hover">
                                    <a href="#"><h4>Thomas Keller</h4></a>
                                    <h5>Chef</h5>
                                    <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="left_event_img">
                                    <img src="{{ asset('img/next-event/next-event-1.jpg')}}t="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="recent_blog_item">
                            <div class="blog_img">
                                <img src="{{ asset('img/blog/recent-blog/recent-blog-1.jpg')}}t="">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="recent_blog_item">
                            <div class="blog_img">
                                <img src="{{ asset('img/blog/recent-blog/recent-blog-2.jpg')}}t="">
                            </div>
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    <h6><a href="#">Articles</a></h6>
                    ...
                    <div class="col-md-4">
                        <div class="recent_blog_item">
                            <div class="blog_img">
                                <img src="{{ asset('img/blog/recent-blog/recent-blog-3.jpg')}}t="">
                            </div>
                            <div class="recent_blog_text">
                                <div class="recent_blog_text_inner">
                                    <h6><a href="#">Articles</a></h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <aside class="f_widget gallery_widget">
                                ...
                                <ul>
                                    <li><a href="#"><img src="{{ asset('img/gallery/f-w-gallery/f-w-gallery-1.jpg')}}t=""><i class="fa fa-search"></i></a></li>
                                    <li><a href="#"><img src="{{ asset('img/gallery/f-w-gallery/f-w-gallery-2.jpg')}}t=""><i class="fa fa-search"></i></a></li>
                                    <li><a href="#"><img src="{{ asset('img/gallery/f-w-gallery/f-w-gallery-3.jpg')}}t=""><i class="fa fa-search"></i></a></li>
                                    <li><a href="#"><img src="{{ asset('img/gallery/f-w-gallery/f-w-gallery-4.jpg')}}t=""><i class="fa fa-search"></i></a></li>
                                    <li><a href="#"><img src="{{ asset('img/gallery/f-w-gallery/f-w-gallery-5.jpg')}}t=""><i class="fa fa-search"></i></a></li>
                                    <li><a href="#"><img src="{{ asset('img/gallery/f-w-gallery/f-w-gallery-6.jpg')}}t=""><i class="fa fa-search"></i></a></li>
                                </ul>
                            </aside>
                        </div>
                    </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="{{ asset('frontend/js/jquery-2.1.4.min.js')}}"></script>
        ...
        <script src="{{asset('frontend/vendors/bootatrap-date-time/bootstrap-datetimepicker.min.js')}}"></script>
        ...
        <script src="{{asset('frontend/vendors/countdown/jquery.countdown.js')}}"></script>
        <script src="{{asset('frontend/vendors/js-calender/zabuto_calendar.min.js')}}"></script>
        <!--gmaps Js-->
